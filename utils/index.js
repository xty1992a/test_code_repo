...
export const ellipsis = count => str => str.length > count ? str.substr(0, count) + "..." : str;
...
export const lowCaseObject = object => Object.keys(object).reduce(
    (pre, key) => ({ ...pre, [key.toLowerCase()]: object[key] }),
    {}
);

export const fmt = str => v => (dayjs(v).isValid() ? dayjs(v).format(str) : v);
